...
# (script being another name for your .py files).  You know how to type 'python.ex13.py' to run the ex13.py file?
...
s = raw_input("enter a variable ")
print s
s = argv 
print "the argv variable is ", s
